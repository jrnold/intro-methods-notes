...
-   Historically: there were some default plug-in estimators, especially for ridge fregression.
...
-   If true distribution of coefficents is a few big ones and many small ones, 
...
-   Approximate best-subset selection. Suppose that we would really like to select
    ...
    Lasso is an appromation of this problem (it is a convex relaxation of the 
    best-subset problem).
...
See <https://arxiv.org/pdf/1603.01700.pdf> and the `r rpkg("hdm")` which implements this method, and extentensions to work with high dimensional data in R.
