...
## Finite Differences and Marginal Effects


A marginal effect is the effect on the conditional mean of the outcome variable,
$y$, from a change in a predictor, $x$.
