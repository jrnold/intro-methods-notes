...
See @Fox2016a for the derivation of the OLS confidence ellipse. The `r rpkg("car")` function `r rdoc("car", "confidenceEllipse")` calculates the confidence ellipse.
See its help page for examples.


## Linear Hypothesis Tests

See @Fox2016a for a discussion. See `r rdoc("car", "LinearHypothesis")` function for an implementation of linear hypothesis testing in R.
