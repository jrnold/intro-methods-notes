...
*consisitency* is a property of an estimator that as the sample size gets larger, it approaches the true value,
$$
...
2. Consistency: linearity, iid, variation in X, uncorrelated errors
3. Unbiasedness: linearity, iid, variation in X, zero conditional mean errors
4. Large-sample inference: linearity, iid, variation in X, zero conditional
mean error, homoskedasticity.
5. Small-sample inference: linearity, iid, variation in X, zero conditional mean error, homoskedasticity, Normal errors
