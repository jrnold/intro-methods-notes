...
However, when the states are categorized by the fraction of students taking the SAT, there is a positive or negligable association between school expenditure and SAT expenditure within each subgroup:
```{r}
mutate(SAT,
