...
Much empirical research is structured as reverse causal questions with "competing theories", asking whether $H1$, $H2$, or $H3$.
Generally, regression cannot be simulataneously used to answer this question.
