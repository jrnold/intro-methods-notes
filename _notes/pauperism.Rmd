...
yule_diff <- yule_long %>%
  ...
  select(ID, Union, Type, year, pauper_diff, outratiodiff, Popn_diff, Prop65_diff)
...
lm(pauper_diff ~ (Type * year) * (outratiodiff + Prop65_diff + Popn_diff), data = yule_diff)
...
plu_shp_1881_url <- str_c("data-raw/EW1881_regdistricts/",
                         "EW1881_regdistricts/EW1881_regdistricts.shp")
plu_shp_1881 <- readShapeSpatial(plu_shp_1881_url)

plu_shp_1891_url <- str_c("data-raw/EW1881_regdistricts/",
                           "EW1891_regdistricts/EW1891_regdistricts.shp")
plu_shp_1891 <- readShapeSpatial(plu_shp_1891_url)
