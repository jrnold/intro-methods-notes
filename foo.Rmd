...
- Also functions of errors are independent of the treatment.
...
- Depends on constant effects, linearity of the effect of $X_i$.
...
- Bertrand, Duflo, and Mullainathan (2004) show that a serial correlation can lead to random, no-effect intervention being significant 45% of the time at the 5% level.
- Placebo test: randomly assign the treatment to generate the null hypothesis distribution.
- Why: DID time series are serially correlated with long pre- and post- treatment.
- What to do?
...
- Leads and lags: current and lagged values of $A_{i,t}$ should affect $Y_{i,t}$ but not future values
