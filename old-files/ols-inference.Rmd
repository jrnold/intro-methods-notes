...
- Standard errors for commonly used hypotheses
  - $\se(\beta_1 + \beta_2) = \sqrt{\Var{\beta_1} + \Var{\beta_2} + \Cov(\beta_1, \beta_2)}$
  - $\se(\beta_1 - \beta_2) = \sqrt{\Var{\beta_1} + \Var{\beta_2} - \Cov(\beta_1, \beta_2)}$
  - $\se(\beta_k (x - x')) = (x - x') \se{\beta_k}$
  - $\se(a \beta_1 + b \beta_2 + c) = \sqrt{a^2 \Var{\beta_1} + b^2 \Var{\beta_2} - ab \Cov(\beta_1, \beta_2)}$
- Delta method
