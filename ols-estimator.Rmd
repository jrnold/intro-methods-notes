...
library("viridis")
library("purrr")
x <- expand.grid(x = seq(-3, 3, by = 0.05),
                 y = seq(-3, 3, by = 0.05))
params <- list(
  list(mu = c(0, 0), Sigma = matrix(c(1, 0, 0, 1), nrow = 2, ncol = 2)),
  list(mu = c(2, 0), Sigma = matrix(c(1, 0, 0, 1), nrow = 2, ncol = 2)),
  list(mu = c(2, 2), Sigma = matrix(c(1, 0, 0, 1), nrow = 2, ncol = 2)),
  list(mu = c(0, 0), Sigma = matrix(c(0.33, 0, 0, 1), nrow = 2, ncol = 2)),
  list(mu = c(0, 0), Sigma = matrix(c(0.33, 0, 0, 0.33), nrow = 2, ncol = 2)),
  list(mu = c(0, 0), Sigma = matrix(c(1, 0.8, 0.8, 1), nrow = 2, ncol = 2)),
  list(mu = c(0, 0), Sigma = matrix(c(1, -0.8, -0.8, 1), nrow = 2, ncol = 2))
)

#ggplot(data.frame(x = x$x, y = x$y, z = p),
  #      aes(x = x, y = y, fill = z)) +
  # geom_raster() +
  # scale_fill_viridis()
